...
| **Improvement-reward RL (entry 88)** | **MASKED PPO IMPLEMENTED; ZERO REGISTERED STEPS.** Controls-first commit `6e3231e`; reachable TRAIN q headroom +0.2984. The 30-test Entry 88 group and 2,661 full tests pass. The runner validates all five artifacts before FINAL TEST can open. Commit policy implementation, then train seeds 00..04 separately. |
