...
| **Margin-adaptation RL (entry 87)** | **PREREGISTERED, NOT IMPLEMENTED OR TRAINED.** D17 fixes the frozen 512-code source, hidden-state split, `-1/-60/+20q` reward, 8-trial episode, controls-first provenance, five 200k-step categorical-PPO seeds and Q1-Q8. Zero SPICE. |
...
| **4ai** | **Train margin-adaptation RL on the frozen 512-code table.** Hidden PVT/channel, receiver-visible eye history, request-conditioned start; controls first, then five registered categorical-PPO seeds | 0 SPICE; 1,000,000 table steps | **PREREGISTERED, NOT IMPLEMENTED.** D17 fixes reward, split, controls, seeds, hyperparameters and Q1-Q8 before code or training. Next: commit this registration, then build fail-first environment/control gates. |
