...
| **4ah** | **Verify the 7.3 dB candidate across the complete bank and mandated PVT grid.** Compare against entry 81 without changing the design, request grid, tolerances, load or channels | exactly 23,040 decks before internal retries | **PRE-REGISTERED as entry 86; not implemented or run.** D15 authorises the distinct resumable run. Production adoption remains a post-result human decision. |
