...
| **7.0 dB diagnostic (D12, entry 83)** | **MEASURED: 5/6 gates passed, OVERALL FAIL.** 7.0176 dB realised, TT noise 0.5357 mV_rms, 14/14 critical points scorable at both 3 and 12 dB, but only **13/16** request pairs fully comply. The last three miss only peak-frequency matching by 0.034-0.055 oct. Per the rule, D11 remains 5.933 dB. |
