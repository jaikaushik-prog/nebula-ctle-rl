...
| **4ah** | **Verify the 7.3 dB candidate across the complete bank and mandated PVT grid.** Compare against entry 81 without changing the design, request grid, tolerances, load or channels | exactly 23,040 decks before internal retries | **IMPLEMENTED, NOT RUN.** The distinct resumable runner, source hashes, control fields and Q1-Q7 gates pass 25 focused tests; the full suite is 2,605/2,605. Commit before launch. Production adoption remains a post-result human decision. |
