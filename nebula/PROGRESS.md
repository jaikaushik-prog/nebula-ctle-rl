...
| **7.0 dB diagnostic (D12, entry 83)** | **IMPLEMENTED AND TESTED; not yet run.** The first command caught a request-identity validator bug before starting SPICE; it is fixed and the suite is 2,583 passed. Exactly 16 real-PMOS invocations remain. The official D11 range remains 5.933 dB. |
