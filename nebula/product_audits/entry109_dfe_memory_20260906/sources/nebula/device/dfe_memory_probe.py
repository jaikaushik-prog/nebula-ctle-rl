"""Entry 109: clean-input isolation of existing NAND memory, NOT a DFE."""
...
def geometry():
    ...
    return {'mos_count': 8, 'gate_geometry_mm2': area, 'full_area_mm2': None,
            'scope': 'isolated memory MOS gate W*L only, not layout or receiver area'}
...
def deck(bits):
    ...
    for source, node, active in (('Vset', 'bx', 1), ('Vreset', 'by', 0)):
