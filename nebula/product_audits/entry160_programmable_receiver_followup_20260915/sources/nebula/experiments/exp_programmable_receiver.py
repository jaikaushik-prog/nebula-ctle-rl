...
OUT=ROOT/'nebula/product_audits/entry160_programmable_receiver_20260915_r3'
    ...
    with hold('dfe_slicer'):
        ...
        try:
            ...
            if choice['nominal_ac_match']:
                ...
                summary['status']='NO_MATCH_IN_BOUNDED_SAMPLE' if len(states)==2 and all(s.get('instrument_ok') for s in states) else 'INCOMPLETE_OR_INVALID'
