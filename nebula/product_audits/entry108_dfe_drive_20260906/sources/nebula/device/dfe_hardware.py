...
def dut_lines(width_um, *, buffered=False, buffer_drive_um=None):
...
def geometry(width_um, *, buffered=False, buffer_drive_um=None):
    dut_lines(width_um, buffered=buffered, buffer_drive_um=buffer_drive_um)
...
def deck(width_um, corner: Corner, common_mode_v: float, bits, *, buffered=False, buffer_drive_um=None):
    ...
    for node, sign in (('inp', 1), ('inn', -1)):
        ...
        lines.append('+ )')
    lines.extend(dut_lines(width_um, buffered=buffered, buffer_drive_um=buffer_drive_um))
