...
`python -m nebula.llm "..."` — the natural-language front end.
    ...
    python -m nebula.llm "6 dB boost at 2.2 GHz" --verify
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    from nebula.design import design, report
    ...
    if args.out:
        ...
        (args.out / "explanation.txt").write_text(text, encoding="utf-8")
        print(f"wrote {args.out / 'design.json'} and "
              f"{args.out / 'explanation.txt'}")
    return 0
